...
public class CompleteGameSetup : MonoBehaviour
{
    ...
    Card CreateCard(string name, string description, CardFaction faction, int cost, int rarity, int baseGold)
    {
        ...
        // Create appropriate effect based on the card
        CardEffect effect = CreateEffectForCard(name, baseGold);
        if (effect != null)
        {
    ...
    CardEffect CreateEffectForCard(string cardName, int baseValue)
    {
        ...
        switch (cardName)
        {
            ...
            case "Tech Hub":
            case "Fortress":
                effect = new SimpleGoldEffect();
                break;
                
            case "Market Stall":
            case "Mystic Circle":
                effect = new SimpleGoldEffect(); // Simplified for now
                break;
        ...
        if (effect != null)
        {
            effect.effectName = $"{cardName} Effect";
    ...
    void CreateGameManagers()
    {
        ...
        if (FindObjectOfType<ShopManager>() == null)
        {
            ...
            // We'll populate the shop with cards after they're created
        }
    ...
    void CreateGameUI(UIDocument uiDocument)
    {
        ...
        Debug.Log("✓ Game UI created programmatically");
    }
    ...
    void CreateTopBar(VisualElement root)
    {
        ...
        topBar.style.borderBottomColor = new Color(0.24f, 0.28f, 0.33f, 1f);
    ...
    VisualElement CreateInfoPanel(string label, string value, string valueName, Color valueColor)
    {
        ...
        panel.style.borderLeftColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        panel.style.borderRightColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        panel.style.borderTopColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        panel.style.borderBottomColor = new Color(0.24f, 0.28f, 0.33f, 1f);
    ...
    VisualElement CreateCardGrid()
    {
        ...
        cardGrid.style.borderLeftWidth = 2;
        cardGrid.style.borderRightWidth = 2;
        cardGrid.style.borderTopWidth = 2;
        cardGrid.style.borderBottomWidth = 2;
        cardGrid.style.borderLeftColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        cardGrid.style.borderRightColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        cardGrid.style.borderTopColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        cardGrid.style.borderBottomColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        ...
        for (int y = 0; y < 3; y++)
        {
            for (int x = 0; x < 3; x++)
            {
                ...
                slot.style.borderLeftColor = new Color(0.24f, 0.28f, 0.33f, 1f);
                slot.style.borderRightColor = new Color(0.24f, 0.28f, 0.33f, 1f);
                slot.style.borderTopColor = new Color(0.24f, 0.28f, 0.33f, 1f);
                slot.style.borderBottomColor = new Color(0.24f, 0.28f, 0.33f, 1f);
    ...
    VisualElement CreateHandContainer()
    {
        ...
        handScroll.style.borderLeftWidth = 2;
        handScroll.style.borderRightWidth = 2;
        handScroll.style.borderTopWidth = 2;
        handScroll.style.borderBottomWidth = 2;
        handScroll.style.borderLeftColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        handScroll.style.borderRightColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        handScroll.style.borderTopColor = new Color(0.24f, 0.28f, 0.33f, 1f);
        handScroll.style.borderBottomColor = new Color(0.24f, 0.28f, 0.33f, 1f);
    ...
    void CreateBottomBar(VisualElement root)
    {
        ...
        bottomBar.style.borderTopColor = new Color(0.24f, 0.28f, 0.33f, 1f);
    ...
    Button CreateStyledButton(string text, string name, bool isPrimary)
    {
        ...
        if (isPrimary)
        {
            ...
            button.style.borderLeftColor = new Color(0.35f, 0.59f, 0.86f, 1f);
            button.style.borderRightColor = new Color(0.35f, 0.59f, 0.86f, 1f);
            button.style.borderTopColor = new Color(0.35f, 0.59f, 0.86f, 1f);
            button.style.borderBottomColor = new Color(0.35f, 0.59f, 0.86f, 1f);
            button.style.color = Color.white;
        }
        else
        {
            button.style.backgroundColor = new Color(0.24f, 0.28f, 0.33f, 1f);
            button.style.borderLeftColor = new Color(0.31f, 0.35f, 0.41f, 1f);
            button.style.borderRightColor = new Color(0.31f, 0.35f, 0.41f, 1f);
            button.style.borderTopColor = new Color(0.31f, 0.35f, 0.41f, 1f);
            button.style.borderBottomColor = new Color(0.31f, 0.35f, 0.41f, 1f);
